...
class _notapproavedState extends State<Verify> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      Container(
        ...
        AlertDialog(
        title: const Text('عزيزي مستخدم مراس',textAlign: TextAlign.center,),
          ...
          child: ListBody(
            children: const <Widget>[
             ...
             // Text('\!',textAlign: TextAlign.center,),
              Text('يمكنك تسجيل الدخول بعد توثيق حسابك عبر الرابط المرسل الى بريدك الإلكتروني',textAlign: TextAlign.center,),
