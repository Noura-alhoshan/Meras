...
class ViewLessonRequestAccept extends StatefulWidget {
  final String id;
  ViewLessonRequestAccept(this.id);

  @override
  _ADcoachProfileScreen3State createState() => _ADcoachProfileScreen3State();
}
...
class _ADcoachProfileScreen3State extends State<ViewLessonRequestAccept> {
                          ...
                          child: Table(
                            ...
                            children: [
                              ...
                              TableRow(children: [
                                Container(
                                    padding: EdgeInsets.all(2.0),
                                    child: document['Paid'] == 'true'
                                        ? Text(
                                            'تم الدفع', //document['TGender'],
                                            style: TextStyle(
                                              height: 1.50,
                                              fontSize: 16.37,
