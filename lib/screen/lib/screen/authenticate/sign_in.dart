          ...
          child: Column(
            children: <Widget>[
              ...
              RoundedPasswordField(
                ...
                validator: (val) => val!.length < 1 ? '             الرجاء إدخال كلمة المرور' : null,//added ! to val
                onChanged: (val) {
            ...
            children: [
              TextButton(
                child: Text('أو حساب مدرب',style: TextStyle(fontSize: 15.5,color: kPrimaryColor,fontWeight: FontWeight.bold),),
                onPressed: () => Navigator.of(context).push(
