...
//  String domain = "https://api.paypal.com"; // for production mode (I won't use it)
  ...
  Future<String?> getAccessToken() async {
    try {
      ...
      var response = await client.post(Uri.parse('$domain/v1/oauth2/token?grant_type=client_credentials'));//added Uri.parse(
  ...
  Future<Map<String, String>?> createPaypalPayment(
    ...
    try {
      var response = await http.post(Uri.parse("$domain/v1/payments/payment"),//added Uri.parse(
