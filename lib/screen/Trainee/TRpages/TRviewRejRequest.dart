...
class ViewRejectedRequest extends StatefulWidget {
  //const ViewRejectedRequest({ Key? key }) : super(key: key);
  final String id;
  ViewRejectedRequest(this.id);

  @override
  _ViewRejectedRequestState createState() => _ViewRejectedRequestState();
}

class _ViewRejectedRequestState extends State<ViewRejectedRequest> {
