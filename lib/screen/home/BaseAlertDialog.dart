...
class BaseAlertDialog extends StatelessWidget {
  ...
  BaseAlertDialog({required String title,required String content,  
                        ...
                        required Function yesOnPressed, required Function noOnPressed, String yes = "Yes", String no = "No"}){
    this._title = title;
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      content: new Text(this._content,style: TextStyle(fontSize: 15.7,),textAlign: TextAlign.center ),
